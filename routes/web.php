...
Route::prefix('image')->middleware(['auth', 'verified'])->group(function () {
...
Route::prefix('roller')->middleware(['auth', 'verified'])->group(function () {
...
Route::prefix('izinler')->middleware(['auth', 'verified'])->group(function () {
...
Route::get('/etkinlikler', 'LogsController@index')->middleware(['auth', 'verified', 'permission:Logs'])->name('Logs');
