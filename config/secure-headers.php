...
/* TODO : yayınlanmadan önce ayarlanmalı. 
github deposu için:
https://github.com/bepsvpt/secure-headers/blob/master/DOCS.md
...
return [
   ...
   *
   * Not: sunucu boş dize olduğunda, yanıt başlığına eklenmez
   */
   ...
   *
   * Mevcut Değer: 'deny', 'sameorigin', 'allow-from <uri>'
   */
   ...
   *
   * Mevcut Değer: 'all', 'none', 'master-only', 'by-content-type', 'by-ftp-filename'
   */
   ...
   * X-Power-By
   *
   * Not: değer boş bir dize ise yanıt başlığına eklenmez.
   */
   ...
   *
   * Mevcut Değer: 'no-referrer', 'no-referrer-when-downgrade', 'origin', 'origin-when-cross-origin',
   ...
   *
   * Lütfen hsts'yi etkinleştirmeden önce web sitenizin SSL/TL ayarladığından emin olun.
   */
  ...
  'feature-policy' => [
    ...
    /*
     * Her yönerge detayı şu adreste bulunabilir:
     *
     * https://github.com/w3c/webappsec-feature-policy/blob/master/features.md
     *
     * 'none', '*' and 'self allow' are mutually exclusive,
     * öncelik 'none' > '*' > 'self allow'.
     */
  ...
  'csp' => [
    ...
    'script-src' => [
      ...
      /* aşağıdakiler yalnızca "script" ve "style" ile ilgili direktifler için geçerlidir */
