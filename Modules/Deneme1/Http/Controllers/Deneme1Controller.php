...
namespace Modules\Deneme1\Http\Controllers;

use App\Traits\ControllerTraits\HelperMethods;
use Illuminate\Http\Request;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Hash;
use Modules\Deneme1\Models\Deneme1;
use Modules\Deneme1\Http\Requests\CreateDeneme1Request;
use Modules\Deneme1\Http\Requests\UpdateDeneme1Request;

class Deneme1Controller extends Controller
{
  use HelperMethods;
  private $model = null;
  ...
  public function index()
  {
    ...
    return view('deneme1::index', compact('settings'));
  }
  ...
  public function create()
  {
    ...
    return view('deneme1::create', compact('settings'));
  }
  
  public function store(CreateDeneme1Request $request)
  {
    $fields = $this->jsonSettings['fields'];
    $operation_type = 'create';
  ...
  public function show($id)
  {
    ...
    return view('deneme1::show', compact('settings'));
  }
  ...
  public function edit($id)
  {
    ...
    return view('deneme1::edit', compact('settings'));
  }
  
  public function update(UpdateDeneme1Request $request, $id)
  {
    $this->model = $this->model->findOrFail($id);
    $fields = $this->jsonSettings['fields'];
    $operation_type = 'update';
