...
namespace Modules\Deneme2\Http\Controllers;

use App\Traits\ControllerTraits\HelperMethods;
use Illuminate\Http\Request;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Hash;
use Modules\Deneme2\Models\Deneme2;
use Modules\Deneme2\Http\Requests\CreateDeneme2Request;
use Modules\Deneme2\Http\Requests\UpdateDeneme2Request;

class Deneme2Controller extends Controller
{
  use HelperMethods;
  private $model = null;
  ...
  public function index()
  {
    ...
    return view('deneme2::index', compact('settings'));
  }
  ...
  public function create()
  {
    ...
    return view('deneme2::create', compact('settings'));
  }
  
  public function store(CreateDeneme2Request $request)
  {
    $fields = $this->jsonSettings['fields'];
    $operation_type = 'create';
  ...
  public function show($id)
  {
    ...
    return view('deneme2::show', compact('settings'));
  }
  ...
  public function edit($id)
  {
    ...
    return view('deneme2::edit', compact('settings'));
  }
  
  public function update(UpdateDeneme2Request $request, $id)
  {
    $this->model = $this->model->findOrFail($id);
    $fields = $this->jsonSettings['fields'];
    $operation_type = 'update';
