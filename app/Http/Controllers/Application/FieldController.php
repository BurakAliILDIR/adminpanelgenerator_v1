...
class FieldController extends Controller
{
	...
	public function store(Request $request, $module_name, $related = false)
	{
		...
		if ($related) {
			...
			$eleman = $this->ordinaryFieldFilling($request, $module_name, $rules);
		}
	...
	public function destroy($module_name, $key)
	{
		...
		// Silinen alanın diğer json source lardaki ilişkili alanlarını silmektedir.
		
		if (@$source['fields'][$key]['relationship']) {
