...
<head>
  ...
  <meta name="author" content="TheNobleBrain">
  <title>AdminPanelGenerator - TheNobleBrain</title>
  {{-- Styles --}}
    ...
    <ul class="navbar-nav mr-auto">
      <li class="nav-item {{ Route::is('log-viewer::dashboard') ? 'active' : '' }}">
        <a href="{{ route('log-viewer::dashboard') }}" class="nav-link">
          <i class="fa fa-dashboard"></i> @lang('Anasayfa')
        </a>
      </li>
...
<footer class="main-footer">
  <div class="container-fluid">
    <p class="text-muted pull-right">
      {{ config('app.name') }} <i class="fa fa-heart"></i> TheNobleBrain <sup>&copy;</sup>
    </p>
  </div>
</footer>
